...
public class SplinePath {
	...
	// Driving part of code ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	public int pathSpeed;
	public static final double LOW_PASS_COEFFICIENT = 0.75;
	public static final double SPEED_COEFFICIENT = 20; // Multiplied to modified input, change in index of target point on path
	...
	public int targetOnPath;

	public double [] update(double controllerInput, double [][] path){

		targetOnPath += (int) ((LOW_PASS_COEFFICIENT * lastInput + (1.0 - LOW_PASS_COEFFICIENT) * controllerInput) * SPEED_COEFFICIENT);
		lastInput = controllerInput;

		return path[targetOnPath];
	}
}